    ...
    <div id="app">
        <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-2 shadow position-fixed w-100">
            ...
            <form action="" method="GET" class="w-100">
                <input class="form-control form-control-dark w-100" type="text" placeholder="Search" aria-label="Search" id="search" name="search" value=""/>
            </form>
                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark navbar-dark sidebar collapse position-fixed h-100">
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link text-white <?php if (startsWith(Route::currentRouteName(), 'admin.dashboard')) {echo 'bg-secondary';} ?>" 
                                    href="{{route('admin.dashboard')}}">
                                    <i class="fa-solid fa-tachometer-alt fa-lg fa-fw pe-1"></i>Dashboard
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white <?php if (startsWith(Route::currentRouteName(), 'admin.dishes')) {echo 'bg-secondary';} ?>" 
